...
<body>
	...
	if (!isset($_SESSION['steamid'])) {
		...
		echo "<div class='bg-primary'><h2>您当前的皮肤配置如下<a class='btn btn-danger' href='{$_SERVER['PHP_SELF']}?logout'>登出</a></h2> </div>";
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<div class="modal-footer">
									...
									<button type="submit" class="btn btn-danger">使用</button>
									</form>
								</div>
							</div>
						</div>
